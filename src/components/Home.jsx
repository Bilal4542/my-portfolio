    ...
    <div className='flex justify-center items-center w-[90%] m-auto  h-screen'>
      <div className="flex items-center justify-center flex-col gap-3">
        ...
        <div className='flex items-center justify-center gap-4 md:text-lg font-semibold'>
          <a href='' className='bg-gradient-to-r from-blue-500 to-blue-300 text-[10px] md:text-lg text-white p-2 md:p-3 rounded-2xl  hover:border-2 hover:border-blue-500 hover:from-blue-300 hover:to-blue-500 cursor-pointer transition-all duration-100'>Download CV</a>
          <a href='' className='border-2 p-2 md:p-3 rounded-2xl text-[10px] md:text-lg border-blue-500 hover:bg-gradient-to-r hover:from-blue-300 hover:to-blue-500 hover:text-white cursor-pointer transition-all duration-100'>Contact Me</a>
          <a href='' className='bg-gradient-to-r from-blue-500 to-blue-300 text-[10px] md:text-lg text-white p-2 md:p-3 rounded-2xl  hover:border-2 hover:border-blue-500 hover:from-blue-300 hover:to-blue-500 cursor-pointer transition-all duration-100'>View Projects</a>
        </div>
