  ...
  return (
    <div className='w-[90%] md:w-[80%] m-auto'>
      <div className="flex flex-col items-center justify-center gap-2 p-8">
        <h1 className='text-2xl md:text-4xl font-bold mt-8'>Get In Touch</h1>
      ...
      <div className="md:grid grid-cols-2 gap-8 mb-10">
        <div className="flex gap-4 items-center shadow p-4 md:p-8 mb-10 md:mb-0 ">
          <div className="">
        ...
        <div className="flex gap-4 items-center p-4 md:p-8 mb-10 md:mb-0  shadow">
          <div className="">
