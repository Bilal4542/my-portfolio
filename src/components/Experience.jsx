...
const Experience = () => {
  return (
    <div className='w-[90%] md:w-[80%] m-auto'>
      ...
      <div className="lg:w-[80%] m-auto p-8 mt-6 md:flex flex-col justify-center gap-3 shadow-xl">
        ...
        <p className='flex items-center text-gray-500 mt-2 mb-2 md:mt-0 md:mb-0 text-[13px] md:text-[15px]'><span className='font-semibold mr-1 md:mr-2'>Tech Pioneers </span> <span className='hidden md:flex items-center gap-1'><LuMapPin/>Onsite</span>, Peshawar, Pakistan</p>
      ...
      <div className="lg:w-[80%] m-auto p-8 mt-12 md:flex flex-col justify-center gap-3 shadow-xl">
        <div className="flex md:items-center md:justify-between gap-3 flex-col md:flex-row">
        ...
        <p className='flex items-center text-gray-500  mt-2 mb-2 md:mt-0 md:mb-0 text-[13px] md:text-[15px]'><span className='font-semibold mr-1 md:mr-2'>Bright Code Lab </span> <span className='hidden md:flex items-center'><LuMapPin/>Onsite</span>, Peshawar, Pakistan</p>
      ...
      <div className="lg:w-[80%] m-auto p-8 mt-12 md:flex flex-col justify-center gap-3 shadow-xl">
        ...
        <p className='flex items-center text-gray-500  mt-2 mb-2 md:mt-0 md:mb-0 text-[13px] md:text-[15px]'><span className='font-semibold mr-1 md:mr-2'>Bingtechs Soultion </span> <span className='hidden md:flex items-center'><LuMapPin/>Onsite</span>, Peshawar, Pakistan</p>
