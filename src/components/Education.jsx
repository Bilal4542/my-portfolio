      ...
      <div className="flex flex-col items-center justify-center gap-2 p-8">
        ...
        <div className="bg-blue-500 rounded h-1 w-[15%] m-auto"></div>
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="shadow-xl p-8 flex flex-col justify-center gap-2 w-[100%]">
                    <h1 className='flex items-center gap-2 font-bold text-xl'>BS Software Engineering <span className='bg-blue-200 text-xl p-3 text-blue-600 rounded-2xl'><FaGraduationCap/></span></h1>
                ...
                <div className="shadow-xl p-8 flex flex-col justify-center gap-2 w-[100%]">
                    <h1 className='flex items-center gap-2 font-bold text-xl'>Certified MERN Stack Developer <span className='bg-blue-200 text-xl p-3 text-blue-600 rounded-2xl'><FaGraduationCap/></span></h1>
                ...
                <div className="shadow-xl p-8 flex flex-col justify-center gap-2 w-[100%]">
                    <h1 className='flex items-center gap-2 font-bold text-xl'>FSC Pre-Engineering <span className='bg-blue-200 text-xl p-3 text-blue-600 rounded-2xl'><FaGraduationCap/></span></h1>
                ...
                <div className="shadow-xl p-8 flex flex-col justify-center gap-2 w-[100%]">
                    <h1 className='flex items-center gap-2 font-bold text-xl'>Matriculation In Science <span className='bg-blue-200 text-xl p-3 text-blue-600 rounded-2xl'><FaGraduationCap/></span></h1>
