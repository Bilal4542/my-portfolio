  ...
  return (
    <div className='w-[80%] m-auto'>
      <div className="flex flex-col items-center justify-center gap-2 p-8">
        <h1 className='text-2xl md:text-4xl font-bold mt-8'>Languages</h1>
        <div className="bg-blue-500 rounded h-1 w-[15%] m-auto"></div>
      </div>
      <div className="md:flex gap-8 items-center justify-center">
        <div className="flex justify-center items-center gap-2 flex-col shadow-xl p-4 md:p-8 mb-10 md:mb-0  w-[100%]">
            <h1 className='font-bold text-2xl md:text-xl lg:text-2xl'>US/UK</h1>
            <p className='font-semibold text-gray-600 text-xl'>English</p>
            <p className='text-gray-600'>Fluent</p>
        </div>
        <div className="flex justify-center items-center gap-2 flex-col shadow-xl p-4 md:p-8 mb-10 md:mb-0  w-[100%]">
            <h1 className='font-bold text-2xl md:text-xl lg:text-2xl'>PK</h1>
